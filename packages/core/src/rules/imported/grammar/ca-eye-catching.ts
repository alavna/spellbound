 ...
 * 
 * Source: LanguageTool (CA_EYE_CATCHING)
 * Category: grammar
 */
export const caEyeCatchingRule: GrammarRule = {
  id: 'ca-eye-catching',
  name: 'Compound adjective: eye catching',
  ...
  check(context: GrammarRuleContext) {
    const pattern = /\beye\b\s+\bcatching\b\s+\S+/gi;
